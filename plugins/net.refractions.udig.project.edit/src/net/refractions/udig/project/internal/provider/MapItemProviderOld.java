 ...
 * @generated NOT
 */
public class MapItemProviderOld extends AbstractLazyLoadingItemProvider
        implements
     ...
     * @generated NOT
     */
    public MapItemProviderOld( AdapterFactory adapterFactory ) {
    ...
    protected ChildFetcher createChildFetcher() {
        return new ChildFetcher(this){
            protected void notifyChanged() {
                MapItemProviderOld.this.notifyChanged(new ENotificationImpl((InternalEObject) parent,
